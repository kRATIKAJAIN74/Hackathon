 ...
 * Handles all interactions with Foodoscope API
 ...
 * Handles missing or partial nutrition data safely
 */
...
export const searchRecipes = async (query, filters = {}) => {
  try {
    ...
    // NOTE: Adjust endpoint based on Foodoscope API documentation
